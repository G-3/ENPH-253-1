...
const int RCServo3Output		= 29 ;

const int Motor_Direction[] 	= {25, 38, 39} ;
const int Motor_EnableDigital[] = {30, 36, 37} ;  //digital input/output values
const int Motor_Enable[] 		= {4,  1,  0} ;   // PWM output values
